...
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/drivers/login">Login Driver</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/drivers/cars/all">Get current drivers cars</a></td></tr>
</table>
</body>
</html>
