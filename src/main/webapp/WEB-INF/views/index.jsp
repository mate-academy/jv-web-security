...
<h1 class="table_dark">Mate academy taxi service :)</h1>
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/cars/driver">Cars by driver id</a></td></tr>
    <tr><td><%@include file="/WEB-INF/views/auth/logout.jsp"%></td></tr>
</table>
</body>
</html>
