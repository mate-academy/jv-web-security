...
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/cars/my">My current cars</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/cars/drivers/add">Add Driver to Car</a></td></tr>
    <tr><td><a href="${pageContext.request.contextPath}/login">Driver authentication</a></td></tr>
</table>
</body>
</html>
