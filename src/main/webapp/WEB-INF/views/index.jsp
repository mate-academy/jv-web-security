...
<table class="table_dark">
    ...
    <tr><td><a href="${pageContext.request.contextPath}/cars/current">Display All Cars for logged driver</a> </td></tr>
    <tr><td><%@include file ="/WEB-INF/views/access/header.jsp" %></td></tr>
</table>
</body>
</html>
