...
<main>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="/drivers" class="nav-link link-dark">
        ...
        <tr>
            <td>
                <table class="table table-bordered border-primary" style="height: 100px; width: 600px">
                    ...
                    <tr>
                        <td><a href="/drivers">Get all drivers</a></td>
                        <td><a href="/manufacturers">Get all manufacturers</a></td>
                        <td><a href="/cars">Get all cars</a></td>
                    </tr>
                    <tr>
                        <td><a href="/drivers/add">Create driver</a></td>
                        <td><a href="/manufacturers/add">Create manufacturer</a></td>
                        <td><a href="/cars/add">Create car</a></td>
                    </tr>
                    <tr>
                        <td>-</td>
                        <td>-</td>
                        <td><a href="/cars/drivers/add">Add driver to car</a></td>
                    </tr>
                </table>
            </td>
        </tr>
